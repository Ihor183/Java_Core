package ua.igorbendera.enumeration;
...
public class Main {
            ...
            switch (action) {
                ...
                case 6: {
                    ...
                    if(season != "") {
                        ...
                        checkPrevNextSeason(season, seasons, seasons.size() - 1, 0, 1);
                    }
                    break;
                }
                case 7: {
                    ...
                    if(season != "") {
                        ...
                        checkPrevNextSeason(season, seasons, 0, seasons.size() - 1, -1);
                    }
                    break;
                }
                case 8: {
                    oddEvenNumberOfDays(months, "парну");
                    break;
                }
                case 9: {
                    oddEvenNumberOfDays(months, "непарну");
                    break;
                }
                case 10: {
                    System.out.println("Enter month");
    ...
    public static String isSeason(ArrayList<Seasons> seasons) {
        Scanner sc = new Scanner(System.in);
        System.out.println("Enter season");
        String season = sc.nextLine();
    ...
    public static void checkPrevNextSeason(String season, ArrayList<Seasons> seasons, int numberForIf, int numberForOutput, int numberForElse) {
        if(Seasons.valueOf(season).ordinal() == numberForIf) {
            System.out.println(seasons.get(numberForOutput));
        } else {
            System.out.println(seasons.get(Seasons.valueOf(season).ordinal() + numberForElse));
        }
    }

    public static void daysInMonth(ArrayList<Months> months, int numberOfAction, Scanner sc) {
        int days = sc.nextInt();
        int count = 0;
        for (Months mon : months) {
    ...
    public static void oddEvenNumberOfDays(ArrayList<Months> months, String str) {
